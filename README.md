# ESP32-WROOM-32 + YOLO: Sistema de Control y Visión por Computadora
...
2. **Detección de vehículos (autos y motos)** mediante un modelo YOLO (You Only Look Once) entrenado previamente, ejecutado en un entorno virtual para demostrar aplicaciones de visión por computadora en tiempo real.
